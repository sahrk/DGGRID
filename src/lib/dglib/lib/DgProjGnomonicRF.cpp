...
DgProjGnomonicRF::DgProjGnomonicRF(DgRFNetwork &networkIn, const string &nameIn,
                                   const DgGeoCoord &proj0In, long double x0In,
                                   long double y0In, long double k0In,
                                   long double to_meterIn,
                                   long double fr_meterIn)
    : DgGeoProjRF(networkIn, nameIn, proj0In, x0In, y0In, k0In, to_meterIn,
                  fr_meterIn) {
...
////////////////////////////////////////////////////////////////////////////////
DgDVec2D DgProjGnomonicRF::projForward(const DgGeoCoord &addIn,
...
////////////////////////////////////////////////////////////////////////////////
DgGeoCoord DgProjGnomonicRF::projInverse(const DgDVec2D &addIn,
                                         const DgEllipsoidRF &) const
//
