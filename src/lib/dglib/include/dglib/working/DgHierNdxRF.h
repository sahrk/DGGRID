...
////////////////////////////////////////////////////////////////////////////////
inline ostream&
operator<< (ostream& stream, const DgHierNdxCoord& coord)
...
template <class T> class DgHierNdxRF<T> : public DgHierNdxRFBase {
   ...
   public:
      ...
      static DgHierNdxRF<T>* makeRF (DgRFNetwork& networkIn, const string& nameIn,
                                  int resIn, int apertureIn)
         { return new DgHierNdxRF<T> (networkIn, nameIn, resIn, apertureIn); }
   ...
   protected:
      ...
      DgHierNdxRF<T> (DgRFNetwork& networkIn, const string& nameIn,
                    int resIn, int apertureIn)
         : DgHierNdxRFBase(networkIn, nameIn, resIn, apertureIn) { }
