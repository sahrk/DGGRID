...
class DgHierNdxRFBase : public DgDiscRF<DgHierNdxCoordBase, long long int> {
   ...
   public:
      ...
      static DgHierNdxRFBase* makeRF (DgRFNetwork& networkIn, const string& nameIn,
                                  int resIn, int apertureIn)
         { return new DgHierNdxRFBase (networkIn, nameIn, resIn, apertureIn); }
   ...
   protected:
      ...
      DgHierNdxRFBase (DgRFNetwork& networkIn, const string& nameIn,
                    int resIn, int apertureIn)
         : DgDiscRF<DgHierNdxCoordBase, long long int>(networkIn, nameIn),
