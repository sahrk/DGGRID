...
## [Unreleased]
### Added
- (work in progress) IVEA projection: new dggs_proj value IVEA and dggs_type presets IVEA3H, IVEA4H, IVEA7H, IVEA43H, IVEA4T and IVEA4D. The DgProjIVEA class is currently a skeleton that delegates to the ISEA (Snyder) projection, so IVEA output is identical to ISEA for now.
### Changed
