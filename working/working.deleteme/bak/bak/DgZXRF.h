...
////////////////////////////////////////////////////////////////////////////////
//
class DgZXCoord : public DgHierNdxIntRF {

   public:

      static const DgZXCoord undefDgZXCoord;
...
class DgZXRF : public DgHierNdxIntRF {
   ...
   public:
      ...
      static DgZXRF* makeRF (const DgIDGGBase& dggIn, const std::string& nameIn,
         ...
         { return new DgZXRF (networkIn, hexDggsIn, nameIn, resIn, apertureIn); }

      virtual const DgZXCoord& undefAddress (void) const
                            { return DgZXCoord::undefDgZXCoord; }
